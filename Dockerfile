...
ENV GID=991 UID=991 UWSGI_WORKERS=1 UWSGI_THREADS=16 IMAGE_PROXY=true REDIS_URL= LIMITER= BASE_URL= NAME=UniVerse%20Search SEARCH_DEFAULT_LANG= SEARCH_ENGINE_ACCESS_DENIED=0 PUBLIC_INSTANCE= \
